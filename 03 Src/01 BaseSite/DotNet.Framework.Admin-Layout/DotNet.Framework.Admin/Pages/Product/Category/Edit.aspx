<%@ Page Title="" Language="C#" MasterPageFile="../../../Pages/Dialog.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="DotNet.Framework.Admin.Pages.Product.Category.Edit" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="floor" runat="server">
    <script>
        $(function () {
            ...
            $.AjaxGet("Ajax.ashx?ajax=getclass", false, {}, function (data) {
                $.RemoveButtonLoading();
                $.RemoveBodyLoading();
            ...
            $("#btn_save").click(function () {
                ...
                if (form.valid()) {
                    $.AjaxPost('?ajax=editdata', true, JSON.stringify(data));
                }
            });
