<%@ Page Title="" Language="C#" MasterPageFile="../../../Pages/Admin.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="DotNet.Framework.Admin.Pages.Product.Category.Index" %>
        ...
        var PageModel = {
            ...
            RowClick: function () {
                if (GetRowIndex != -1) {
                    ...
                    _self = this;
                    $.RemoteDialog("修改产品类别", "<%:DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Pages/Product/Category/edit.aspx?classid=" + id, {
                        height: 500,
                        width: 500,
                        close: function () {
            ...
            RowDelete: function () {
                ...
                if (GetRowIndex != -1) {
                    if ($.Confirm("删除后不可恢复，确定继续吗？")) {
                        ...
                        $.AjaxPostCall('?ajax=deleteclass', true, { ClassID: id }, function (data) {
            ...
            Insert: function () {
                _self = this;
                $.RemoteDialog("添加产品类别", "<%:DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Pages/Product/Category/add.aspx", {
                    height: 500,
                    width: 500,
                    close: function () {
                        //alert("关闭了")
