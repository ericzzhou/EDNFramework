<%@ Page Title="" Language="C#" MasterPageFile="../../Admin.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="DotNet.Framework.Admin.Pages.Account.User._default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="floor" runat="server">
    <script>
        ...
        var selectedRole = -1;
        var PageModel = {
            virtualPath: '<%=DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Pages/Account/User',
            ...
            AddUserDialog: function () {
                _self = this;
                $.RemoteDialog("添加用户", this.virtualPath + "/insert.aspx", {
                    height: 620,
                    width: 600,
            ...
            EditMembers: function () {
                ...
                if (GetRowIndex != -1) {
                    ...
                    $.RemoteDialog("修改用户", this.virtualPath + "/edit.aspx?id=" + uid, {
                        height: 620,
                        width: 600,
