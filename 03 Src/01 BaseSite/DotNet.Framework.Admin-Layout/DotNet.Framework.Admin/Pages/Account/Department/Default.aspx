<%@ Page Title="" Language="C#" MasterPageFile="../../Admin.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="DotNet.Framework.Admin.Pages.Account.Department.Default" %>
    ...
    <script>
        ...
        var PageModel = {
            ...
            AddDepartment: function () {
                _self = this;
                $.RemoteDialog("添加部门", "<%:DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Pages/Account/Department/add.aspx", {
                    height: 560,
                    width: 500,
                    //buttons: {
                    //    '关闭': function () {
            ...
            EditDepartment: function () {
                ...
                if (GetRowIndex != -1) {
                    ...
                    $.RemoteDialog("修改部门", "<%:DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Pages/Account/Department/edit.aspx?id=" + id, {
                        height: 560,
                        width: 500,
                        //buttons: {
                        //    '关闭': function () {
