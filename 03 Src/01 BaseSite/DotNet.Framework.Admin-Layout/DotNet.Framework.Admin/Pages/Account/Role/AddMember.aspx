<%@ Page Title="" Language="C#" MasterPageFile="../../Dialog.Master" AutoEventWireup="true" CodeBehind="AddMember.aspx.cs" Inherits="DotNet.Framework.Admin.Pages.Account.Role.AddMember" %>
    ...
    <script>
        $(function () {
            ...
            $("#btn_save").click(function(){
                ...
                if (cbs_str != "") {
                    $.AjaxPost('?ajax=addmember', true,{rid:roleId,users:cbs_str});
                }
                else{
