<%@ Page Title="" Language="C#" MasterPageFile="../../Admin.Master" AutoEventWireup="true" CodeBehind="role_permission_user.aspx.cs" Inherits="DotNet.Framework.Admin.Pages.Account.Role.role_permission_user" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="floor" runat="server">
    <script>
        ...
        var PageModel = {
            ...
            pqsAjaxSource: 'role_permission_user.aspx?ajax=getlistbyroleid&roleid=<%=Request["roleid"]%>',
            GridID: '#grid_user',
            Init: function () {
                _self = this;
            ...
            { title: "邮件", width: 180, dataIndx: "Email" },
            {
                ...
                PQLoadGrid("U.UserID", this.GridID, url, colM, 20, false);
                $(this.GridID).pqGrid({
                    freezeCols: 4,
