...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [["fullscreen","source","undo","insertunorderedlist","insertorderedlist","link","unlink","|","gmap","pagebreak","insertimage","snapscreen","emotion","insertframe","date","time","wordimage","map","anchor","spechars","blockquote","insertcode","bold","italic","underline","strikethrough","forecolor","backcolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","touppercase","tolowercase","directionalityltr","directionalityrtl","indent","removeformat","formatmatch","autotypeset","paragraph","lineheight","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","inserttable","deletetable","mergeright","mergedown","splittorows","splittocols","insertcol","insertrow","deletecol","deleterow","insertparagraphbeforetable"],[],[]]
