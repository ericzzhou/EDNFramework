<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Control_SubNavbar.ascx.cs" Inherits="DotNet.Framework.Admin.Controls.Control_SubNavbar" %>
            ...
            <ul class="mainnav">
                ...
                <li id="LOG" class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <%--<li><a href="<%:ResourcePath%>/Pages/Log/SysLog/Index.aspx">操作日志</a></li>
                        <li class="divider"></li>
                        <li><a href="<%:ResourcePath%>/Pages/Log/UserLog/Index.aspx">用户日志</a></li>
                        <li><a href="<%:ResourcePath%>/Pages/Log/UserLog/Index.aspx">登录日志</a></li>--%>
                    </ul>
                </li>
                ...
                <li id="SYSTEM" class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <%--                        <li><a href="<%:ResourcePath%>/Pages/ControlPanel/SysMailConfig/Index.aspx">邮件配置</a></li>
                        <li><a href="<%:ResourcePath%>/Pages/ControlPanel/SysFilterWords/Index.aspx">敏感词配置</a></li>--%>
                    </ul>
                </li>
