<%@ Page Title="" Language="C#" MasterPageFile="../../Admin.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="DotNet.Framework.Admin.UI.Pages.Account.Role._default" %>
            ...
            RowDelete: function () {
                ...
                if (GetRowIndex != -1) {
                    if ($.Confirm("删除后不可恢复，确定继续吗？")) {
                        ...
                        $.AjaxPostCall(url.ajaxUrl + 'deletemodel', false, { RoleID: id }, function (data) {
