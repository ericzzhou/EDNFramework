<%@ Page Title="" Language="C#" MasterPageFile="../../Admin.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="DotNet.Framework.Admin.UI.Pages.Account.Permission.Index" %>
                ...
                <div class="widget-content">
                    <div class="tab-pane active form-horizontal" id="info">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="textarea">
                                    <button class="btn btn-large btn-block btn-primary" id="btn__PermissionActions" type="button">权限按钮维护</button>
                                </div>
                            </div>
                        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="floor" runat="server">
    ...
    <script>
        var url = {
            ajaxUrl: '<%=DotNet.Framework.Admin.Core.Config.ConfigHelper.AjaxPath%>/Account/Permission.ashx?ajax='
            , PermissionActionsUrl: '<%=DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Pages/Account/PermissionActions/index.aspx?PermissionCode='
        }
        ...
        var PageModel = {
            ...
            Model_Save: function () {
                _self = this;
                _self.LoadFormData();
                $.AjaxPostCall(url.ajaxUrl + 'savedata', false, _self.data, function (data) {
                    $.RemoveBodyLoading();
                    $.RemoveButtonLoading();
