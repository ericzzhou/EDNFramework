<%@ Page Title="" Language="C#" MasterPageFile="../../Dialog.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="DotNet.Framework.Admin.UI.Pages.Account.User.Edit" %>
    ...
    <script>
        ...
        var PageModel = {
            ...
            Init: function () {
                ...
                $.AjaxGet(url.ajaxUrl + "getdepartment", false, {}, function (data) {
                ...
                $("#btn_Save").click(function () {
                    _self.LoadData();
                    $.AjaxPost(url.ajaxUrl + 'updatemodel', false, _self.data);
            ...
            GetDate: function () {
                ...
                $.AjaxGet(url.ajaxUrl + 'getmodel&id=' + id, false, {}, function (data) {
