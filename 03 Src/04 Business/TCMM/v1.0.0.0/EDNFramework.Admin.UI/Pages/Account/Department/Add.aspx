<%@ Page Title="" Language="C#" MasterPageFile="../../Dialog.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="DotNet.Framework.Admin.UI.Pages.Account.Department.Add" %>
        ...
        var PageModel = {
            ...
            Init: function () {
                ...
                $("#btn_Insert").click(function () {
                    _self.LoadData();
                    $.AjaxPost(url.ajaxUrl + 'adddata', false, JSON.stringify(_self.data));
