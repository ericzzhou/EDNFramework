            ...
            <ul>
                <li>
                    <a href="https://www.google.com/chrome?hl=en&brand=CHMI">
                        <img border="0" src="<%:DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Resource/Images/browselogo/chromelogo.png" alt="Chrome" /></a>
                </li>
                <li>
                    <a href="http://www.mozilla.org/en-US/firefox/fx/">
                        <img border="0" src="<%:DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Resource/Images/browselogo/firefoxlogo.png" alt="Firefox" /></a>
                </li>
                <li>
                    <a href="http://www.apple.com/safari/download/">
                        <img border="0" src="<%:DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Resource/Images/browselogo/safari_logo.png" alt="Safari" /></a>
                </li>
                <li>
                    <a href="http://www.opera.com/products/">
                        <img border="0" src="<%:DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Resource/Images/browselogo/operalogo.png" alt="Opera" /></a>
                </li>
                <li>
                    <a href="http://windows.microsoft.com/en-us/internet-explorer/products/ie/home">
                        <img border="0" src="<%:DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Resource/Images/browselogo/ielogo.png" alt="IE" /></a>
                </li>
            </ul>
        </div>
    </div>
