<%@ Page Title="" Language="C#" MasterPageFile="../../Dialog.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="DotNet.Framework.Admin.UI.Pages.Account.PermissionActions.Edit" %>
        ...
        <div class="tab-pane active form-horizontal bind-valid " id="tb_form">
            ...
            <div class="control-group">
             ...
             <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" class="input-medium  require" readonly="true" id="ActionCode" name="ActionCode" />
                </div>
            </div>
        </div>
     ...
     <script>
        ...
        $(function () {
            ...
            $("#btn_Insert").click(function () {
                ...
                if (form.valid()) {
                    $.AjaxPost(url.ajaxUrl + 'edit', false, JSON.stringify(data));
                }
            });
        });
    </script>
