...
{     
	public class ALL
	{
		...
		Entity_SYS_FloatAD SYS_FloatAD = new Entity_SYS_FloatAD();
		Entity_SYS_ErrorLog SYS_ErrorLog = new Entity_SYS_ErrorLog();
		Entity_CMS_PhotoClass CMS_PhotoClass = new Entity_CMS_PhotoClass();
		Entity_SYS_SingleJumpAD SYS_SingleJumpAD = new Entity_SYS_SingleJumpAD();
		...
		/// <summary> 
		/// Entity_SYS_FloatAD的注释
		/// </summary> 
		[Serializable]
		public class Entity_SYS_FloatAD
		{
			[DataMapping("ID")]
			public Int32 ID { get; set; }
		...
		/// <summary> 
		/// Entity_SYS_SingleJumpAD的注释
		/// </summary> 
		[Serializable]
		public class Entity_SYS_SingleJumpAD
		{
			[DataMapping("ID")]
			public Int32 ID { get; set; }
