...
namespace DotNet.Framework.MVC.Extend.Extends
{
    public static class Slide
    {
        ...
        /// <returns></returns>
        public static string EDNFHelper_GenerateSlide(this HtmlHelper helper, string containerParentID, string containerClass, string itemClass, int slideId, string defaultImgSrc)
        {
