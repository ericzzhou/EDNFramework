        ...
        var PageModel = {
            ...
            RowClick: function () {
                ...
                if (GetRowIndex != -1) {
                    ...
                    $.RemoteDialog("编辑友情链接", "<%:DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Pages/Other/FLink/edit.aspx?id=" + id, {
                        height: 600,
                        width: 700,
                        close: function () {
                            //alert("关闭了")
            ...
            Insert: function () {
                _self = this;
                $.RemoteDialog("添加友情链接", "<%:DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Pages/Other/FLink/add.aspx", {
                    height: 600,
                    width: 700,
                    close: function () {
                        //alert("关闭了")
