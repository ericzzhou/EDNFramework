...
<asp:Content ID="Content3" ContentPlaceHolderID="floor" runat="server">
    <script>
        ...
        var PageModel = {
            ...
            Insert: function () {
                _self = this;
                $.RemoteDialog("添加幻灯片组", "<%:DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Pages/Other/Slide/Group/Add.aspx", {
                    height: 390,
                    width: 500,
                    close: function () {
                        //alert("关闭了")
            ...
            Edit: function () {
                ...
                if (GetRowIndex != -1) {
                    ...
                    $.RemoteDialog("编辑幻灯片组", "<%:DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Pages/Other/Slide/Group/Edit.aspx?id=" + id, {
                        height: 390,
                        width: 500,
                        close: function () {
                            //alert("关闭了")
