...
<asp:Content ID="Content3" ContentPlaceHolderID="floor" runat="server">
    <script>
        ...
        var PageModel = {
            ...
            Insert:function(){
                _self = this;
                $.RemoteDialog("添加幻灯片", "<%:DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Pages/Other/Slide/item/Add.aspx", {
                    height: 550,
                    width: 500,
                    close: function () {
                        //alert("关闭了")
            ...
            Edit:function(){
                ...
                if (GetRowIndex != -1) {
                    ...
                    $.RemoteDialog("编辑幻灯片", "<%:DotNet.Framework.Admin.Core.Config.ConfigHelper.ResourcePath%>/Pages/Other/Slide/Item/Edit.aspx?id=" + id, {
                        height: 550,
                        width: 500,
                        close: function () {
                            //alert("关闭了")
            ...
            Delete:function(){
                ...
                if (GetRowIndex != -1) {
                    ...
                    if ($.confirm("删除后不可恢复，确定继续吗？")) {
                        //删除
                        $.AjaxPost('?ajax=delete&id='+id, true, null);
                        _self.RefreshGrid();
                    }
                }
                else {
