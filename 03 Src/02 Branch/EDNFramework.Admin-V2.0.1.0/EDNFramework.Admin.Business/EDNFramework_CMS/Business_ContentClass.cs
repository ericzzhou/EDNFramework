...
", orderField, dir);
        ...
        public static PagingResult<IList<Entity_ContentClass_GetList>> GetListByPager(ViewQueryCondition<object> query)
        {
            PagingResult<IList<Entity_ContentClass_GetList>> result = new PagingResult<IList<Entity_ContentClass_GetList>>();
...
", query.PagingInfo.OrderField, query.PagingInfo.SortDir);
            ...
            result.Result = cmd.ExecuteEntities<Entity_ContentClass_GetList>();
