<%@ Page Title="" Language="C#" MasterPageFile="../../../Pages/Admin.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="DotNet.Framework.Admin.UI.Pages.Product.Item.Edit" %>
        ...
        var PageModel = {
            ...
            LoadContentClass: function () {
                $.AjaxGet(url.ajaxUrlCategory+"getclass", false, {}, function (data) {
                    ...
                    edit_Description.html(json.Description);
