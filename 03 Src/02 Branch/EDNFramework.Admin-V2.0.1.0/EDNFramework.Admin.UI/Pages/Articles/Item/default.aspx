<%@ Page Title="" Language="C#" MasterPageFile="../../Admin.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="DotNet.Framework.Admin.UI.Pages.Articles.Item._default" %>
        ...
        var PageModel = {
            ...
            Bind: function () {
                ...
                var colM = [
                    ...
                    {
                        title: "权重", width: 65, dataIndx: "CON.Sequence",
                        render: function (ui) {
                    ...
                    {
                        title: "属性", width: 150, dataIndx: "IsTop",
                        render: function (ui) {
                            var rowData = ui.rowData;
                            var html = "";
                ...
                PQLoadGrid("ContentID", this.GridID, url, colM, 20, false, { ClassID: classid, Title: title });
                $(this.GridID).pqGrid({
                    freezeCols: 2,
