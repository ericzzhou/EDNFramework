<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Admin.Master" AutoEventWireup="true" CodeBehind="entering.aspx.cs" Inherits="DotNet.Framework.Admin.Pages.Norm.Item.entering" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="server">
    <EDNFramework:BreadCrumb ID="BreadCrumb1" runat="server" BreadCrumbContent="指标维护 > 指标录入" />
    <div class="span3">
        <div class="widget">
