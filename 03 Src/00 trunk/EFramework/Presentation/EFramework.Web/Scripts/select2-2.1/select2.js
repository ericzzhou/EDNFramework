...
(function ($, undefined) {
    ...
    */
    $(document).ready(function () {
        $(document).delegate("*", "mousedown focusin touchend",
        function (e) {
    ...
    */
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        */
        getContainerWidth: function () {
            ...
            if (this.opts.width !== undefined) return this.opts.width;
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            ...
            }).html(["    <a href='javascript:void(0)' class='select2-choice'>", "   <span></span><abbr class='select2-search-choice-close' style='display:none;z-index:999999;'></abbr>", "   <div><b></b></div>", "</a>", "    <div class='select2-drop' style='display:none;z-index:999999;'>", "   <div class='select2-search'>", "       <input type='text' autocomplete='off'/>", "   </div>", "   <ul class='select2-results'>", "   </ul>", "</div>"].join(""));
        },
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            ...
            "  <li class='select2-search-field'>", "    <input type='text' autocomplete='off' style='width: 25px;'>", "  </li>", "</ul>", "<div class='select2-drop' style='display:none;'>", "   <ul class='select2-results'>", "   </ul>", "</div>"].join(""));
        },
    ...
    $.fn.select2 = function () {
        ...
        value,
        multiple,
        allowedMethods = ["val", "destroy", "open", "close", "focus", "isFocused", "container", "onSortStart", "onSortEnd", "enable", "disable"];
