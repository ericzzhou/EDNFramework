...
";
            ...
            object obj = cmd.ExecuteSingle() ?? string.Empty;
            return obj.ToString();
...
", sortBy, dir);
        ...
        public static IList<Entity_ConfigContent> GetListByPager(ViewQueryCondition<Entity_ErrorLog_Condition> query, out int totolCount)
        {
            throw new NotImplementedException();
        }

        public static PagingResult<IList<Entity_ConfigContent>> GetListByPager(ViewQueryCondition<Entity_ErrorLog_Condition> query)
        {
            PagingResult<IList<Entity_ConfigContent>> result = new PagingResult<IList<Entity_ConfigContent>>();
...
", query.PagingInfo.OrderField, query.PagingInfo.SortDir);
            ...
            result.Result = cmd.ExecuteEntities<Entity_ConfigContent>();
