<%@ Page Title="" Language="C#" MasterPageFile="../../../Pages/Dialog.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="DotNet.Framework.Admin.UI.Pages.Repairs.Brand.Edit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <EDNFramework:BreadCrumb ID="BreadCrumb1" runat="server" BreadCrumbContent="报修系统 > 品牌修改" />
    ...
    <script>
        ...
        var PageModel = {
            Init: function () {
                ...
                $.AjaxGet(url.ajaxUrl + 'getmodel&id=<%=Request["id"] %>', false, {}, function (data) {
                    $.RemoveButtonLoading();
                    $.RemoveBodyLoading();
            ...
            ApplyEvent: function () {
                ...
                $("#btn_Update").click(function () {
                    ...
                    $.AjaxPost(url.ajaxUrl + 'update', false, JSON.stringify(form.getformdata()));
