<%@ Page Title="" Language="C#" MasterPageFile="../../../../Pages/Dialog.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="DotNet.Framework.Admin.UI.Pages.Other.Slide.Item.Add" %>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#btn_Insert").click(function () {
                ...
                if (form.valid()) {
                    $.AjaxPost(url.ajaxUrl+ 'additem', false, JSON.stringify(data));
                }
            });
        });
    </script>
