        ...
        return this.each(function () {
            ...
            object = function (length) {
                ...
                this.NumBtnDom = function (list, w, h, l, t) {
                    return "<dl style=\"z-index:1100;width:" + w + "px;height:" + h + "px;position:absolute;left:" + l + "px;top:" + t + "px;\">" + list + "<dl>";
                };
                this.arrow = function (l, r, w, h, x, y) {
                    //return "<em class=\"sPrev\" id=\"sPrev\" style=\"position:absolute;cursor:pointer;z-index:1000;width:" + w + "px;height:" + h + "px;left:" + (l - w - x) + "px;\"></em><em class=\"sNext\" id=\"sNext\" style=\"position:absolute;cursor:pointer;z-index:1000;width:" + w + "px;height:" + h + "px;left:" + (r + x) + "px;top:" + y + "px;\"></em>";
                    return "<em class=\"sPrev\" id=\"sPrev\" style=\"position:absolute;cursor:pointer;z-index:1000;width:" + w + "px;height:" + h + "px;left:10px;\"></em><em class=\"sNext\" id=\"sNext\" style=\"position:absolute;cursor:pointer;z-index:1000;width:" + w + "px;height:" + h + "px;left:880px;top:" + y + "px;\"></em>";
                };
